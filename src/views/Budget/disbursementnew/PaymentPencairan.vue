...
<!-- v-if="item.period_budget == currentPeriod ? disabled='true' : disabled='false'" -->
                            <v-list dense class="pt-0 pb-0">
                                ...
                                <v-list-item :disabled="isEditDisabled(item)" @click="[detailItemEdit(item), showApprove2 = false]">
                                    <v-list-item-icon>
    ...
    methods: {
        ...
        async getDetailReqPencairan(event, detail, index){
            ...
            if (event === null || event === '') {
                ...
                // TODO belum ditambah flag, saat ini juga nda dipake sih
