                    ...
                    <template v-slot:[`item.action`]="{ item }">
                        ...
                        >
                            ...
                            <v-list dense>
                                ...
                                <v-list-item v-if="(showButtonAprv1 || showButtonAprv2)" @click="reject(item)">
                                    <v-list-item-icon>
                                        <v-icon>mdi-close</v-icon>
                                    </v-list-item-icon>
                                    <v-list-item-content>
                    ...
                    <v-container>
                        <v-row class="mb-5">
                            ...
                            <v-col class="col-12" sm="6" md="4">
                                <h6 class="blue-lcd mb-1">Target Remark</h6>  
                                <v-text-field
                                    solo
                                    dense
                                    persistent-hint
                            ...
                            <v-col class="col-12" sm="6" md="3">
                                <h6 class="blue-lcd mb-0">Target Type <span class="red--text"><strong>* </strong></span></h6>   
                                <v-radio-group
                                    v-model="type"
                                    row
                                    dense
                ...
                <v-card-text>
                    <v-container>
                        <v-row class="mb-5">
                            ...
                            <v-col class="col-12" sm="6" md="4">
                                <h6 class="blue-lcd mb-0">Target Remark</h6>  
                                <v-text-field
                                    solo
                                    dense
                                    persistent-hint
                ...
                <v-card-text>
                    <v-container>
                        <v-row class="mt-2 mb-5">
                            ...
                            <v-col class="col-12" sm="12" md="12">
                                <h6 class="blue-lcd mb-0">Target Type </h6>   
                                <v-radio-group
                                    v-model="type"
                                    row
                                    dense
...
export default {
    ...
    data() {
        return {
            ...
            headers:[
                { text: 'AC Num', value: 'ac_num' , align:'left', width:'120'},
