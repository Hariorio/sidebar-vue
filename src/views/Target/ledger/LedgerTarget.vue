            ...
            <v-col cols="12">
                ...
                <v-tabs-items v-model="tab">
                    ...
                    <v-tab-item
                        value="tab-2"
                    >
                        <activity-ledger-target></activity-ledger-target>
                    </v-tab-item>
                </v-tabs-items>
                    ...
                    <v-card class="p-2 rounded-l">
                        ...
                        <v-card-text>
                            ...
                            <v-container v-if="showDetail && this.activity_headers.length > 0">
                                <v-row>
                                    <v-col cols="12">
                                        <h5 class="blue-lcd mb-1">Activity Target</h5>
                                    </v-col>
                                </v-row>
...
export default {
    ...
    methods: {
        ...
        async getApplConstant(){
            ...
            var respDataTabs = await appl_constant.fetchApplConstant("?key_value=TARGET&str2=LEDGER TARGET&sort_order=asc&order_by=int1", null, false, false, false)
